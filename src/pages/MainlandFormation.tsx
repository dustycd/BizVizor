      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 lg:px-8 xl:px-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {/* License Fees */}
            <div className="bg-grey-50 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-heading-dark mb-2">License Fees</h3>
              <p className="text-primary-red text-2xl font-bold mb-2">Starting AED 12,500</p>
              <p className="text-grey-600 text-sm">Covers initial registration and trade license issuance.</p>
            </div>

            {/* Local Service Agent */}
            <div className="bg-grey-50 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
              <div className="w-16 h-16 bg-primary-navy/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Users className="w-8 h-8 text-primary-navy" />
              </div>
              <h3 className="text-xl font-semibold text-heading-dark mb-2">Local Service Agent</h3>
              <p className="text-primary-navy text-2xl font-bold mb-2">AED 5,000–8,000/year</p>
              <p className="text-grey-600 text-sm">Required for professional licenses, facilitates government dealings.</p>
            </div>

            {/* Office Lease */}
            <div className="bg-grey-50 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
              <div className="w-16 h-16 bg-alert-success/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <MapPin className="w-8 h-8 text-alert-success" />
              </div>
              <h3 className="text-xl font-semibold text-heading-dark mb-2">Office Lease</h3>
              <p className="text-alert-success text-2xl font-bold mb-2">From AED 6,000/year</p>
              <p className="text-grey-600 text-sm">Cost for flexi-desks or virtual office solutions.</p>
            </div>
            ...
            <div className="bg-grey-50 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-heading-dark mb-2">Visa Processing</h3>
              <p className="text-primary-red text-2xl font-bold mb-2">AED 3,500–7,000 per visa</p>
              <p className="text-grey-600 text-sm">Includes application, medical, and Emirates ID for each visa.</p>
            </div>
          </div>
